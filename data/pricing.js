...
export const tiers3 = [
  {
    ...
    linkUrl: "https://app.centrecall.ai/register",
    linkSubtext: "",
    features: [
      ...
      "3 calls in parallel",
      "1 cloned voice",
      "900 no-code automate platform runs monthly",
    ],
    isPopular: false,
  },
  {
    ...
    linkSubtext: "",
    features: [
      "700 included minutes, then $0.16 / extra minute",
      "5 assistants",
  ...
  },
  {
    ...
    linkSubtext: "",
    features: [
      "1700 included minutes, then $0.09 / extra minute",
  ...
  },
  {
    ...
    description: "Boost revenue with AI call automation under your brand.",
    price: "$419",
    yearlyPrice: "$355",
    priceDetails: "Per month",
    linkText: "Subscribe now",
    ...
    linkSubtext: "",
    features: [
      "3500 included minutes, then $0.09 / extra minute",
      "Unlimited assistants",
      "Unlimited outbound campaigns",
      "1,000 calls in parallel",
      "Unlimited cloned voices",
      "Unlimited no-code automate platform runs",
...
export const pricingPlans3 = [
  {
    ...
    link: "https://app.centrecall.ai/register",
