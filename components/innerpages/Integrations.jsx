          ...
          <div className="section-inner panel mt-2 sm:mt-4 lg:mt-0">
            ...
            >
              <h1 className="h2 sm:h1 lg:display-6 xl:display-5 m-0">
                Connect CenterCall with Your Favorite Tools
              </h1>
              <p className="fs-6 sm:fs-5 text-dark dark:text-white text-opacity-70">
                Seamlessly integrate AI voice agents with 250+ business tools using our no-code platform. Connect CRMs, calendars, and automation platforms in minutes.
              </p>
            </div>
            <div className="panel">
              <div
